...
import com.tribune.adit2.logging.model.Test;
import com.tribune.adit2.logging.model.TestLog;
import com.tribune.adit2.logging.model.TestRun;
import com.tribune.adit2.util.Configurator;
import com.tribune.adit2.util.Util;
...
public class TestLogListener implements  ITestListener, IInvokedMethodListener
{
	...
	private synchronized void flushLogMessages(ITestResult result, Logger logger) {	
		String testName = result.getTestClass().getName() + "." + result.getMethod().getMethodName();
		List<LogMessage> logMessages = com.tribune.adit2.testng.Logger.getLogMessages(result);
