...
public class OrderRecurrenceTest 
{
	/**
	 * This test will create an order and add a recurrence to it
	 */
	@Test(groups = {"Order","createRecurrenceOrder"}, dataProviderClass = com.tribune.adit2.data.TribuneUserDataProvider.class, dataProvider = "userData")
	   public void createRecurrenceOrder(Map<String, String> userData) throws Exception
	   {
		   try
		   {
		       ...
		       //newOrderInstance.enterEndsOn("31", "Dec", "2017");
