...
public class InsrtnPreprintOrderPandDSpecTest 
{
	/**
	 * This test will create a new insertion order for a preprint product type 
	 * with P and D specifications
	 */
	@Test(groups = {"InsertionOrder2"}, dataProviderClass = com.tribune.adit2.data.TribuneUserDataProvider.class, dataProvider = "userData")
	public void ioPreprintPandDSpec(Map<String, String> userData) throws Exception
	{
		try
		   {
