...
public class OrderErrBillToCustMandatoryPOTest 
{
	/*This test tries to create a general order with a bill to customer(who requires a PO number
	 * to submit an order) without the PO number
	 * */
		...
		try
		   {
		       ...
		       newOrderInstance.enterBillToCustomer("CU00001436");
		      ...
		      // newOrderInstance.selectOrderRouting("OrderRouting_BillAndFulFill");
		       ...
		       newOrderInstance.compareErrorMessageSingleErr(userData, "MandatoryPO#SpecificBillTo");
