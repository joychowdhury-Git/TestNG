	...
	public class NewsPaperLayoutAddNewAdBlock 
	{
		/**
		...
		@Test(groups = {"NewsPaperLayouts","AddNewAdBlock","NewsPaperLayoutsReg","RegressionLatest","Grp3","RegressionLatest","Group2","TestPriority"}, dataProviderClass = com.tribune.adit2.data.TribuneUserDataProvider.class, dataProvider = "userData")
		public void addNewAdBlock(Map<String, String> userData) throws Exception
		{
			try
			   {
			       ...
			       Thread.sleep(4000);
			       layoutViewPage.enterPositionX("1");
			       layoutViewPage.enterPositionY("9.0001");
