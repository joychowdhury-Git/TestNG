...
public class OrderErrMandatorySalesPersonTest 
{
	/*This test tries to create a general order with all the required information excluding the 
	 * sales person
	 * */
		...
		try
		   {
		      ...
		      // newOrderInstance.selectOrderRouting("OrderRouting_BillAndFulFill");
		       ...
		       newOrderInstance.deleteSalesPerson("SA01380");
		       Thread.sleep(2000);
		       newOrderInstance.submitOrder();
		       newOrderInstance.displayErrorMessage();
		       newOrderInstance.compareErrorMessageSingleErr(userData, "MandatorySalesPerson");
