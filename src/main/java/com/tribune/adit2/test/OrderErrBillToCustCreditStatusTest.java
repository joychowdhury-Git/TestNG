...
public class OrderErrBillToCustCreditStatusTest 
{
	/*This test tries to create a general order with a Bill to customer having credit status as STOP
	* */
		...
		try
		   {
		       ...
		       newOrderInstance.enterBillToCustomer("CU00294836");
		       ...
		       newOrderInstance.compareErrorMessageSingleErr(userData, "BillToCreditStatus");
