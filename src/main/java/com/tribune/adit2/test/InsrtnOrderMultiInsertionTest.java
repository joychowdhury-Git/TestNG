...
public class InsrtnOrderMultiInsertionTest 
{
	/**
	 * This test creates an Insertion order with multiple insertions
	 * 
	 */
	@Test(groups = {"InsertionOrder"}, dataProviderClass = com.tribune.adit2.data.TribuneUserDataProvider.class, dataProvider = "userData")
	   public void multiInsertion(Map<String, String> userData) throws Exception
	   {
		   try
		   {
