...
public class InsrtnPreprintOrderMatchZipTest 
{
	/**
	...
	public void ioPreprintMatchZip(Map<String, String> userData) throws Exception
	{
		try
		   {
		       ...
		       newOrderInstance.clickOnMatchZipLink();
