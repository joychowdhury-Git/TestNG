...
public class OrderSearchByExternalRef 
{
	/**
	 * This test perform a search on orders for a particular order status
	 */
	@Test(groups = {"verifySearchByExternalRef","RegressionLatest","Grp1","Run1","Group3","PrioritizedReg3","NewRegression3","NewRegression","G1","searchOrders"}, dataProviderClass = com.tribune.adit2.data.TribuneUserDataProvider.class, dataProvider = "userData")

	public void verifySearchByExternalRef(Map<String, String> userData) throws Exception
	{
		try
		   {
		     ...
		     //  driver.findElement(By.xpath(".//*[@id='app']/div[3]/div[2]/div[2]/div[1]/div/div[1]/div[1]/div/div/div/ul/li[9]/label/i")).click();
		       driver.findElement(By.xpath("//label[text()='Keyword ']/../div/div/ul/li[8]/label/i")).click();
		       Thread.sleep(3000);
		       driver.findElement(By.xpath(".//*[@id='keyword']")).click();
		       driver.findElement(By.xpath(".//*[@id='keyword']")).sendKeys("Adit 2.0");
