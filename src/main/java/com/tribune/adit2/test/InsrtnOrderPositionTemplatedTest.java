...
public class InsrtnOrderPositionTemplatedTest 
{
	/* This test creates a new Insertion Order for a display product type
		...
		try
		   {
		       ...
		       newOrderInstance.selectPostionFrmPositionSlctr("17", "0, 0.5");
