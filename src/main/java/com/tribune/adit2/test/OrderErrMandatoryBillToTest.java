...
public class OrderErrMandatoryBillToTest 
{
	/*This test tries to create a general order without Bill to customer and 
		...
		try
		   {
		      ...
		      // newOrderInstance.selectOrderRouting("OrderRouting_BillAndFulFill");
		       ...
		       newOrderInstance.compareErrorMessageSingleErr(userData, "MandatoryBillTo");
