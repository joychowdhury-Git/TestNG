...
public class OrderSearchByBookDateSevenDays 
{
	/**
	 * This test perform a search on orders for a particular order status
	 */
	@Test(groups = {"verifySearchByBookDateSevenDays","RegressionLatest","PrioritizedReg3","Grp1","Run1","Group3","NewRegression","G1","searchOrders"}, dataProviderClass = com.tribune.adit2.data.TribuneUserDataProvider.class, dataProvider = "userData")

	public void verifySearchByBookDateSevenDays(Map<String, String> userData) throws Exception
	{
		try
		   {
		     ...
		     //  driver.findElement(By.xpath(".//*[@id='app']/div[3]/div[2]/div[2]/div[1]/div/div[1]/div[1]/div/div/div/ul/li[9]/label/i")).click();
		       driver.findElement(By.xpath("//label[text()='Keyword ']/../div/div/ul/li[9]/label/i")).click();
		       Thread.sleep(3000);
		       driver.findElement(By.xpath("//*[@id='keyword']")).click();
		       driver.findElement(By.xpath("//*[@id='keyword']")).sendKeys("Mary Jordan");
		       Thread.sleep(2000);
		       driver.findElement(By.xpath("//*[@id='bookdateRange']")).click();
		       Thread.sleep(3000);
		       //driver.findElement(By.xpath("html/body/div[3]/div[3]/ul/li[3]")).click();//swagata
		       driver.findElement(By.xpath("(//div[@class='ranges']//li[text()='Last 7 days'])[2]")).click();//swagata
		       Thread.sleep(3000);
