...
public class IODashboardNewOrderType 
{
	/**
	 * This test clicks on new orders and verifies the order entry search page. 
	 * count of the new orders is viewed
	 */
	@Test(groups = {"DashboardIO","Regression","dashboardNewOrderType","dashboardNewOrdersProd"}, dataProviderClass = com.tribune.adit2.data.TribuneUserDataProvider.class, dataProvider = "userData")
	public void dashboardNewOrderType(Map<String, String> userData) throws Exception
	{
		try
		   {
		       ...
		       Assert.assertEquals(orderType,"Order"); 
