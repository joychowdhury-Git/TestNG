...
public class IODashboardOrdersErrorOutLinkTest 
{
	/**
	 * This test clicks on orders error out and verifies the order entry search page. 
	 * count of the orders error out is viewed
	 */
	...
	public void dashboardIOErrorOut(Map<String, String> userData) throws Exception
	{
		try
		   {
		       ...
		       int countOfOrders = dashboardPageInstance.getCountOfOrdersErrOut();
		       Logger.info("countOf Orders error out = "+countOfOrders);
		       dashboardPageInstance.clickOnOrdersErrorOutLink();
		    ...
		    //   OrderEntryHomePage orderSearch = PageFactory.initElements(driver, OrderEntryHomePage.class);
		       ...
		       if(type.equalsIgnoreCase("Insertion Order"))
		       {
		    	   typeFlag = true;
